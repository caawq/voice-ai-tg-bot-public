...
BOT_COMMANDS = [
    ...
    BotCommand(command="week", description="Картинка недели"),
    BotCommand(command="theme", description="Тема картинки: light или dark"),
...
START_TEXT = (
    ...
    "и сохраню только после вашего подтверждения. Текстом — так же: просто "
    "напишите сообщение, если говорить неудобно.\n\n"
    "Что дальше:\n"
    "/today — что на сегодня\n"
    "/list — все записи с фильтрами\n"
    "/week — картинка недели\n"
    "/theme — светлая или тёмная картинка\n"
    "/settings — настройки\n"
    "/help — подробнее\n\n"
...
HELP_TEXT = (
    "Как пользоваться\n\n"
    "Голосом или текстом. Надиктуйте (или напишите) всё подряд, одним "
    "сообщением. Я разберу его на записи "
    ...
    "/theme light или /theme dark — тема картинки\n"
